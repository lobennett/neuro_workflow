#!/usr/bin/env python3
"""Level 1 GLM Analysis script using modular network_lev1 package."""
...
from network_lev1.core.task_utils import detect_sample_type, get_expected_sessions
from network_lev1.core.utils import (
...
from network_lev1.io.file_discovery import FileFinder
from network_lev1.processing.confounds import get_fc_confounds, load_and_process_confounds
from network_lev1.processing.contrasts import (
    compute_run_contrasts,
    filter_contrasts_for_dropped_columns,
)
from network_lev1.processing.design import create_design_matrix
from network_lev1.processing.events import (
    add_junk_trials,
    load_bold_data_with_dummy_removal,
    preprocess_events,
    save_simplified_events,
)
from network_lev1.processing.fixed_effects import compute_subject_fixed_effects
from network_lev1.processing.glm import (
    fit_run_glm,
    handle_zero_variance_columns,
    validate_glm_inputs,
)
from network_lev1.processing.masks import MaskProcessor
from network_lev1.processing.quality_control import run_quality_control
from network_lev1.processing.residuals import process_run_residuals, process_surface_residuals
...
from network_lev1.task_config.loader import get_task_contrasts, get_task_parameters
